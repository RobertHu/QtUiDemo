...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UpdateThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 45, 6)
    ...
    "UpdateThread\0SendPriceSignal\0\0TradeItem\0"
    "item\0Update\0"
};
...
void UpdateThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->SendPriceSignal((*reinterpret_cast< const TradeItem(*)>(_a[1]))); break;
        ...
        {
            typedef void (UpdateThread::*_t)(const TradeItem & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UpdateThread::SendPriceSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject UpdateThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_UpdateThread.data,
      qt_meta_data_UpdateThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UpdateThread.stringdata))
...
// SIGNAL 0
void UpdateThread::SendPriceSignal(const TradeItem & _t1)
{
